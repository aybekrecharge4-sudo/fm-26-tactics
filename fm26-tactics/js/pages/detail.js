            ...
            <div class="detail-layout">
                ...
                <div>
                    ...
                    <div style="margin-top:12px;display:flex;flex-wrap:wrap;align-items:center;gap:12px">
                        <a href="${DataStore.getDownloadUrl(tactic.slug)}" download="${esc(tactic.slug)}.fmf" class="btn btn-primary" onclick="event.stopPropagation()">
                            &#11015; Download Tactic (.fmf)
                        </a>
                        <span style="font-size:0.8rem;color:var(--fm26-text-muted)">
                            Save to <strong>Documents/Sports Interactive/Football Manager 2026/tactics</strong>
                        </span>
                    </div>
