        ...
        return `
            <div class="tactic-card" onclick="Router.navigate('tactic/${tactic.slug}')">
                ...
                <div class="tactic-card-stats">
                    ...
                    <a href="${DataStore.getDownloadUrl(tactic.slug)}" download="${esc(tactic.slug)}.fmf" class="tactic-card-download" onclick="event.stopPropagation()" title="Download .fmf file">
                        &#11015;
                    </a>
                </div>
            </div>
